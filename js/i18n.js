const I18N = {
  es: {
    ...
    'curriculum.lede': 'Manolo Granado (Sevilla, 1978) vive y trabaja entre Sevilla y Madrid. Su obra explora la materia, el gesto y la forma circular como eje compositivo, combinando pintura, grabado y técnica mixta.',
    ...
    'contacto.studio.value': 'Sevilla, España',
  ...
  en: {
    ...
    'curriculum.title': 'CV',
    'curriculum.lede': 'Manolo Granado (Seville, 1978) lives and works between Seville and Madrid. His work explores matter, gesture and the circular form as a compositional axis, combining painting, printmaking and mixed media.',
    ...
    'contacto.studio.value': 'Seville, Spain',
    'contacto.email.label': 'Email',
